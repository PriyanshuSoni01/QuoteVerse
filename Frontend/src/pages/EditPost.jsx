...
import { updatePost, resetUpdateState, getPostById } from '../../slices/PostsSlice.js';
...
const EditPost = () => {
  ...
  // Initialize form data with post data
  useEffect(() => {
    if (currentPost && !isInitialized) {
      setFormData({
        title: currentPost.title || '',
        content: currentPost.content || '',
        type: currentPost.type || 'quote',
